  ...
  addStepIfPresent(steps, '[data-tour="session-status"]', {
    popover: {
      ...
      description: isContext
        ...
        : isImport
          ? '状态会在启动中、执行中、待命中、已结束之间切换。导入完成后可以查看下载位置和项目文件。'
          : isSelfEvolve
            ? '状态会在启动中、执行中、待命中、已结束之间切换。完成后重点看修改文件和构建结果。'
          : isExtension
            ? '状态会在启动中、执行中、待命中、已结束之间切换。完成后重点看原型、README 和日志说明是否更新。'
            : '状态会在启动中、执行中、待命中、已结束之间切换。完成后重点看修改文件和最终回复。',
      side: 'bottom',
      align: 'center',
    },
  })
